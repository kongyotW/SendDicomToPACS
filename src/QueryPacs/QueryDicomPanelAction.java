 ...
 * @author cti
 */
public class QueryDicomPanelAction implements ActionListener {

    private final QueryDicomPanel queryPanel;
    private final InfoPanel infoPanel;

    public QueryDicomPanelAction(QueryDicomPanel queryPanel, InfoPanel infoPanel) {
